...
const firebaseConfig = {
    ...
    databaseURL: "https://chat-jcubic-default-rtdb.firebaseio.com",
  ...
  // Initialize Firebase
  firebase.initializeApp(firebaseConfig);function unpollute(cls, thunk) {
    try {
        var polluted = {};
...
jQuery(function($) {
    ...
    function init(term, username="username") {
